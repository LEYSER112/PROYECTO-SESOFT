...
<body>
        ...
        <div class="details">
            ...
            <form action="php/cambiar_contraseña.php" method="post">
                ...
                <div class="password-icons">
                    <i id="icon-length" class="fa-solid fa-circle-xmark password-icon"></i> Mínimo 5 caracteres<br>
                    <i id="icon-uppercase" class="fa-solid fa-circle-xmark password-icon"></i> Al menos 1 mayúscula<br>
                    <i id="icon-lowercase" class="fa-solid fa-circle-xmark password-icon"></i> Al menos 1 minúscula<br>
                    <i id="icon-number" class="fa-solid fa-circle-xmark password-icon"></i> Al menos 1 número
                </div>
                <div class="form-group">
    ...
    <script src="scripts/validacion_contraseña.js"></script>
